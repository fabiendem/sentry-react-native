...
- Bump JavaScript SDK from v10.65.0 to v11.0.0 ([#2](https://github.com/fabiendem/sentry-react-native/pull/2))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#1100)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/10.65.0...11.0.0)
